...
.. automodule:: selkie.pyx.object

Types, reflexion, generic object — ``selkie.pyx.object``
========================================================
...
.. py:function:: string_to_module(s)
   ...
   module::
      ...
      >>> from selkie.pyx.object import string_to_module
...
.. py:function:: string_to_object(s)
   ...
   module name, to get the object::
      ...
      >>> from selkie.pyx.object import string_to_object
...
.. py:class:: Object()
   ...
   dot syntax as well as square-bracket syntax::
      ...
      >>> from selkie.pyx.object import Object
      >>> x = Object()
      >>> x['hi'] = 10
      >>> x.bye = 20
      >>> x.hi
...
.. py:function:: matches(x, desc)
   ...
   *X* is an object and *desc* is a dict,
   ...
   >>> from selkie.pyx.object import matches
   >>> class Point (object):
